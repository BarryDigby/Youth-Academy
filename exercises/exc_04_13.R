...
dmat <- dist(expr[,2:6], method = "___________")
...
# plot heatmap
pheatmap(as.matrix(____), 
         clustering_distance_rows = dmat, 
         clustering_distance_cols = dmat,
         show_rownames = F, show_colnames = F,
         scale = "___", color = greenred(200),
         annotation_col = _______,
         annotation_row = _______,
         annotation_colors = ______)